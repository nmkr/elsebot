...
;(function ( $, window, document, undefined ) {
    ...
    ajaxLoader.prototype = {
        ...
        _init: function( el, options ) {
            ...
            this.container = $(el);
            var options = this.options = $.extend({}, ajaxLoader.defaults, options);
            ...
            if (this.options.ajaxEnabled == false) {
                this.options.requestDone.call(this, instance); 
                return;
            }
            ...
            if (history.pushState) {
                ...
                $(document).on('click', this.options.linkSelector, function(e) {
        ...
        _finished: function() {
            var instance = this;
            this.options.requestDone.call(this, instance);
            this._log('ajaxLoader: request finished');

            this._form();

            this.scrollToElement = false;
            if(this.usePushState === false){
